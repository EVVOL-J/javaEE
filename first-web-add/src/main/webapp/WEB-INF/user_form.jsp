...
<div class="container">
    <div class="row py-2">
        <div class="col-12">
            <c:url value="/user" var="userEditUrl"/>
            <form action="${userEditUrl}" method="post">
                ...
                <div class="form-group">
                    <label>PhoneNumber Format:+7(xxx)xxx-xx-xx</label>
                    <input type="tel" class="form-control" id="phoneNumber" name="phoneNumber" pattern="\+7\([0-9]{3}\)[0-9]{3}-[0-9]{2}-[0-9]{2}" value="${user.phoneNumber}" placeholder="Enter Phone ">
                </div>
